...
for DATA_TYPE in "${DATATYPES[@]}"; do
    python3 -m verl.trainer.main_generation_vllm2 \
        trainer.nnodes=1 \
        trainer.n_gpus_per_node=8 \
        data.path=$HOME/data/${DATA_TYPE}.parquet \
