...
scripts/eval_itds_checkpoint.py
scripts/convert_limit_of_rlvr_outputs.py
limit-of-RLVR/math/       Copied verifier/eval dependency
...
OBJECTIVE=tb \
TRAIN_DATA=$PWD/data/full_train_subtb.jsonl \
...
```bash
bash scripts/run_rollout.sh dry-run
```
